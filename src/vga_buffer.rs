...
// driver, so we use it as our `println!` backend.
...
pub fn _print(args: fmt::Arguments) {
    use core::fmt::Write;
    // Disable interrupts while we hold the writer lock. Without this, a
    // timer/keyboard interrupt that also tries to print would deadlock.
